...
int64 nChainStartTime = 1402152670;
...
const string strMessageMagic = "Alliancecoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1){
	       nSubsidy = 25000 * COIN; // first 1 blocks for 0.5%
	       return nSubsidy + nFees;
	     }
	  else if(nHeight > 1 && nHeight <= 28800){
	  	   nSubsidy = 103 * COIN; // 34AAC for per block
	  	   return nSubsidy + nFees;
	  	 }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Alliancecoin
    bool fStrictPayToScriptHash = true; // Always active in Alliancecoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Alliancecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "AAC is good coin";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x8b65a71b672e5ce65f650d8962d2d9ba1abea7ed737e541dd70d92226f6a716c"));
...
unsigned char pchMessageStart[4] = { 0x71, 0x15, 0x42, 0xf5 };
